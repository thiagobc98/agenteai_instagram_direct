...
// IA responde automaticamente às mensagens recebidas no Instagram Direct. Mantemos
// o composer visível (para consistência do layout de caixa de entrada) porém
